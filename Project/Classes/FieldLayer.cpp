...
void FieldLayer::changeMap(string MapKey) // 맵맵체인지
{
	CMap * map = StaticContentsContainer::readMapMap(MapKey); // 리드맵맵
	...
	DynamicContentsContainer::getInstance()->getCharacter()->
		setPoint(DynamicContentsContainer::getInstance()->getMap()->getStartPoint()); // 시각포인트 설정 
